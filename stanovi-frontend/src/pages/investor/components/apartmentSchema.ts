...
export const apartmentSchema = z.object({
  ...
  floor: z.number().int().min(0, 'Sprat ne može biti negativan'),
  rooms: z.number().positive('Broj soba mora biti veći od 0'),
  area: z.number().positive('Površina mora biti veća od 0'),
